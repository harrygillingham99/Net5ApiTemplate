...
using NetCore5ApiTemplate.Exceptions;
using NetCore5ApiTemplate.Objects;
using NetCore5ApiTemplate.Objects.Responses;
using NSwag.Annotations;
using TestResponse = NetCore5ApiTemplate.Objects.Responses.TestResponse;

namespace NetCore5ApiTemplate.Controllers
{
    [ApiController]
    [Route("Example")]
